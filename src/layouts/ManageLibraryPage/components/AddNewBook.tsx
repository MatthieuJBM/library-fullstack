...
export const AddNewBook = () => {
  ...
  function getBase64(file: any) {
    // FileReader lets the browser read the content of the file stored on the user's
    // computer using file or blob object to specify the data to read.
  ...
  async function submitNewBook() {
    ...
    if (
      ...
      if (!submitNewBookResponse.ok) {
        throw new Error("Something went wrong submitting the book!");
      }
      setTitle("");
      setAuthor("");
      setDescription("");
